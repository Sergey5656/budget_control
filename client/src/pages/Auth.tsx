...
import {setTokenToLocalStorage} from "../halper/localstorage.helper";
...
const dispatch = useAppDispatch()
    ...
    const loginHandler = async (e: React.FormEvent<HTMLFormElement>) => {
        try {
            ...
            const error = err.response?.data.media
...
const error = err.response?.data.message
    ...
    return (
        <div className="mt-40 flex flex-col items-center justify-center bg-slate-900 text-white">
            ...
            <form onSubmit={isLogin? loginHandler:registrationHandler} className="mx-auto flex w-1/3  flex-col gap-5">
